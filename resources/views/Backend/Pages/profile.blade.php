            ...
            <div class="card">
                <div class="card-body">
                    <div class="media align-items-center mb-4">
                        <img class="mr-3" src="{{url('/Backend/images/avatar/11.png')}}" width="80" height="80" alt="">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="media media-reply">
                        <img class="mr-3 circle-rounded" src="{{url('/Backend/images/avatar/2.jpg')}}" width="50" height="50" alt="Generic placeholder image">
                        <div class="media-body">
                            ...
                            <img class="mr-3 circle-rounded circle-rounded" src="{{url('/Backend/images/avatar/4.jpg')}}" width="50" height="50" alt="Generic placeholder image">
                            <div class="media-body">
                                <div class="d-sm-flex justify-content-between mb-2">
                                    <h5 class="mb-sm-0">Milan Gbah <small class="text-muted ml-3">about 3 days ago</small></h5>
                                    <div class="media-reply__link">
