                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="{{route('adminLogin.process')}}" method="post">
                                    @csrf

                                    @if (session()->has('role'))
                                        <p class="alert alert-success">{{session()->get('role')}}</p>
                                    @endif
                                ...
                                <p><a href="{{route('adminPassword.forget')}}" class="text-primary">Forget password?</a></p>
                                <p class="login-form__footer">Don't have account? <a href="{{route('admin.registration')}}" class="text-primary">Sign Up</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
